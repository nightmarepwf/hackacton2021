 ...
 */
@Suppress("unused")
abstract class BaseFragmentDialog<T: ViewDataBinding, VS: BaseViewState, OSE: BaseOneShotEvent, FMVI: BaseModelViewIntent<VS, OSE>>(
    private val layoutId: Int,
): DialogFragment(), IMVIObserver<VS, OSE> {
