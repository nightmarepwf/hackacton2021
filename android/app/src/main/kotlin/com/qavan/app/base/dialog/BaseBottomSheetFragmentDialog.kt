 ...
 */
@Suppress("unused")
abstract class BaseBottomSheetFragmentDialog<T: ViewDataBinding, VS: BaseViewState, OSE: BaseOneShotEvent, FMVI: BaseModelViewIntent<VS, OSE>>(
    private val layoutId: Int,
): BottomSheetDialogFragment(), IMVIObserver<VS, OSE> {
