...
abstract class BaseMainFragmentDialog<T: ViewDataBinding, VS: BaseViewState, OSE: BaseOneShotEvent, FMVI: BaseFragmentMVI<VS, OSE>>(
    layoutId: Int,
): BaseFragmentDialog<T, VS, OSE, FMVI>(layoutId) {
